...
export default function BannerContinuousScroll() {
      ...
      <div className="relative h-[400px] md:h-[500px] lg:h-[600px] w-full overflow-hidden">
        ...
        >
          ...
          {bannerItems.map((item, index) => (
            <div key={item.id} className="relative" style={{ width: `${100 / bannerItems.length}%` }}>
              <div
                className="absolute inset-0"
                style={{
                  animation: isPaused ? "none" : "slideRightToLeft 20s linear infinite",
              ...
              <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 lg:px-24 max-w-3xl">
                <div className="overflow-hidden mb-4">
                  <h2
                    className={cn(
                      ...
                      index === activeIndex ? "opacity-100 transform-none" : "opacity-0",
                    )}
                  >
                    {item.title}
                  </h2>
                ...
                <div
                  className={cn(
                    ...
                    index === activeIndex ? "opacity-100 scale-x-100" : "opacity-0 scale-x-0",
                  )}
                />
