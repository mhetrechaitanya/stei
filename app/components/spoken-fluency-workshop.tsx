...
export function SpokenFluencyWorkshop() {
  return (
    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
      <div className="relative h-48">
        <Image
          src="/placeholder.svg?height=200&width=400"
          alt="Spoken Fluency Workshop"
          fill
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          <span className="text-sm font-medium bg-[#FFF5F5] text-[#D40F14] px-3 py-1 rounded-full">₹4,999</span>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="space-y-2 mb-4">
            <li className="flex items-start">
              ...
              <span className="text-sm">Improve pronunciation and fluency</span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="h-4 w-4 text-[#D40F14] mr-2 flex-shrink-0 mt-0.5" />
              <span className="text-sm">Expand your vocabulary and grammar</span>
            </li>
            <li className="flex items-start">
              <CheckCircle className="h-4 w-4 text-[#D40F14] mr-2 flex-shrink-0 mt-0.5" />
              <span className="text-sm">Build confidence in speaking English</span>
            </li>
          </ul>
        </div>
