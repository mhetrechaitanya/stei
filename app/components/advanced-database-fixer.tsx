...
import { AlertCircle, CheckCircle, Loader2, Database, Copy, ExternalLink } from "lucide-react"

export default function AdvancedDatabaseFixer() {
...
SELECT * FROM students WHERE email = 'test@example.com';`
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h1 className="text-2xl font-bold mb-6">Advanced Database Structure Repair</h1>
      ...
      <div className="mb-8 p-4 bg-yellow-50 border border-yellow-200 rounded-md">
        <h2 className="text-lg font-semibold mb-2 flex items-center">
          <Database className="h-5 w-5 mr-2 text-yellow-700" />
          Manual Database Fix Instructions
        </h2>
        <p className="mb-4 text-yellow-800">
          If the automatic fix doesn't work, you can manually create the students table by following these steps:
        </p>
        <ol className="list-decimal pl-5 mb-4 space-y-2 text-yellow-800">
          <li>
            Go to your{" "}
            <a
      ...
      <div className="mt-8 p-4 border-t pt-6">
        ...
        <p className="mb-4">Once you've successfully created the students table, follow these steps:</p>
