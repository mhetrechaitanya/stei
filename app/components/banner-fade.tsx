  ...
  return (
    ...
    >
      ...
      <div className="relative h-[400px] md:h-[500px] lg:h-[600px] w-full">
        {/* Current slide */}
        <div className={cn("absolute inset-0 z-10", isAnimating ? "fade-left" : "")}>
          <Image
            ...
            <div className="overflow-hidden mb-4">
              <h2
                className={cn(
                  ...
                  isAnimating ? "opacity-0 -translate-x-8" : "opacity-100 transform-none",
                )}
              >
        ...
        {isAnimating && (
          <div className="absolute inset-0 z-20 fade-right">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-center px-8 md:px-16 lg:px-24 max-w-3xl">
              <div className="overflow-hidden mb-4">
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white opacity-0 animate-[fadeIn_0.5s_0.3s_forwards]">
                  {bannerItems[nextIndex].title}
                </h2>
              </div>

              <div className="w-20 h-1 bg-[#D40F14] mb-6 origin-left opacity-0 animate-[scaleIn_0.5s_0.4s_forwards]" />

              <div className="overflow-hidden mb-8">
                <p className="text-lg md:text-xl text-white/90 opacity-0 animate-[fadeIn_0.5s_0.5s_forwards]">
              ...
              <div>
                <a
                  ...
                  className="inline-block bg-[#D40F14] hover:bg-[#B00D11] text-white font-medium py-2 px-6 rounded-full opacity-0 animate-[fadeIn_0.5s_0.6s_forwards]"
                >
