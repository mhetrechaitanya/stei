...
export default function BatchSelector({ workshop, onSelect, onBack, studentData, initialBatchId }: BatchSelectorProps) {
  ...
  console.log("I am in batch selector");
  console.log("data in the batch selector ", workshop)
