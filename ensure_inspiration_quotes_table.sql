...
BEGIN
    IF NOT EXISTS (
        ...
        -- Create the inspiration_quotes table
        ...
        INSERT INTO inspiration_quotes (quote, author, category, color, is_featured) VALUES
        ...
        RAISE NOTICE 'Created inspiration_quotes table and inserted initial quotes';
    ELSE
        RAISE NOTICE 'inspiration_quotes table already exists';
    END IF;
END$$;

-- Display the current quotes in the table
SELECT * FROM inspiration_quotes;
